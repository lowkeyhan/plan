   ...
   <div class="weui_cells weui_cells_form">
    <div class='weui_cell '>
     ...
     <a class="weui_btn weui_btn_primary hiddn" id="finish">确认完成</a>
        <a class="weui_btn weui_btn_default" style="width:49%;float:right" id="gohome">返回</a>
   <a class="weui_btn weui_btn_warn hiddn" style="width:49%;float:left" id="delect">删除</a>
